...
- **clarifier**: Analyzes user requests and asks clarifying questions when the request is ambiguous or out of scope
...
2. `generator` - Create the workflow skeleton with null prompts
